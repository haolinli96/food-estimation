...
def create_unimib_label_colormap():
  """Creates a label colormap used in UNIMIB segmentation benchmark.
  Returns:
    A colormap for visualizing segmentation results.
  """
  colormap = np.zeros((256, 3), dtype=np.uint8)
  ...
  colormap[1] = [244, 35, 232]
  colormap[2] = [70, 70, 70]
  colormap[3] = [102, 102, 196]
  colormap[4] = [190, 153, 153]
  colormap[5] = [9, 110, 190]
  colormap[6] = [250, 170, 30]
  colormap[7] = [35, 142, 107]
  colormap[8] = [191, 100, 234]
  return colormap
...
def create_label_colormap(dataset=_PASCAL):
  ...
  elif dataset == _UNIMIB:
    return create_unimib_label_colormap()
  else:
